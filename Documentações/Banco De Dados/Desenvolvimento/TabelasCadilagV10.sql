...
-- Table `Cadilag`.`link`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `Cadilag`.`link` ;

CREATE TABLE IF NOT EXISTS `Cadilag`.`link` (
...
-- Table `Cadilag`.`voto`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `Cadilag`.`voto` ;

CREATE TABLE IF NOT EXISTS `Cadilag`.`voto` (
  `Usuario_usu_id` INT NOT NULL,
  ...
  CONSTRAINT `fk_Usuario_has_Resposta_Resposta1`
    ...
    REFERENCES `Cadilag`.`Resposta` (`resp_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `Cadilag`.`MaterialDidatico`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `Cadilag`.`MaterialDidatico` ;

CREATE TABLE IF NOT EXISTS `Cadilag`.`MaterialDidatico` (
