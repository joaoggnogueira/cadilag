...
CREATE TABLE IF NOT EXISTS `Cadilag`.`Turma` (
  ...
  `disc_id` INT NULL,
  `tur_descricao` VARCHAR(512) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `Cadilag`.`Arquivo` (
  ...
  `arq_disponivel` TINYINT(1) NOT NULL,
  `arq_id` INT NOT NULL,
  `Usuario_usu_id` INT NULL,
  `Path_arquivo` VARCHAR(100) NULL,
  INDEX `fk_Arquivo_Usuario1_idx` (`Usuario_usu_id` ASC),
