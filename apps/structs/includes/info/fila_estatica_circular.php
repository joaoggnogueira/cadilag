<i>"Uma fila é um conjunto ordenado de itens a partir do qual podem-se 
    ...
    podem-se inserir itens na outra extremidade (chamada fim da fila)."
    <b>(Tenenbaum)</b>
    <br/><br/>
    Fila Estática Circular é uma adaptação da Fila Estática para reaproveitar
    as posições vazias, geradas após a remoção. Na maioria das vezes é chamada 
    só de Fila Estática.
</i> 
<br/><br/>
<details>
<summary>Mais informações</summary>
    ...
    <ul>
        <li>
            ...
            Além disso, reaproveita o espaços removidos.
        </li>
        <li>
