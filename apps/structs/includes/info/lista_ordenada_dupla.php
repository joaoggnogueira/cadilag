...
<summary>Mais informações</summary>
    ...
    <ul>
        <li>
            ...
            respectivamente) do que o valor pesquisado. Armazena somente o número necessário de elementos e a ligação dupla trás mais facilidade
            para recuperar elementos vizinhos.
        </li>
        <li>
            <b>Desvantagem:</b> A inserção requer mais tempo e gasta mais memória armazenar ponteiros anteriores.
        </li>
    </ul>
</details>