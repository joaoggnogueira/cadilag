...
<summary>Mais informações</summary>
    ...
    <ul>
        <li>
            <b>Vantagem:</b> Pode se armazenar em qualquer ordem, 
            armazena somente o número necessário de elementos, e é possível remover um 
            elemento intermediário sem causar gasto de memória. A ligação dupla trás mais facilidade
            para recuperar elementos vizinhos.
        </li>
        <li>
            <b>Desvantagem:</b> Os valores não são ordenados, portanto, a busca de um elemento 
            é linear. Maior complexidade no algoritmo e custo maior de memória para armazenar 
            o ponteiro para o elemento anterior.
        </li>
    </ul>
    <br/>
