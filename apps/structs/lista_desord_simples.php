<?php
    session_start();
    $idestrutura = 4;
    $nameestrutura = 'Lista com Encadeamento Simples - Sem Ordenação';
    $name_struct = "lista_desordenada_simples.php";
...
<html dir="ltr" lang="pt-BR">
    ...
    <body id="bd">
        ...
        <script src="./js/Estruturas/lista_desord_simples.js"></script>
    </body>
</html>
