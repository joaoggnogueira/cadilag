<?php
    session_start();
    $idestrutura = 23;
    $nameestrutura = 'Fila Estática Circular<br/>(FIFO)';
    $name_struct = 'fila_estatica_circular.php';
    $entradasProgramadasCompativeis = [1,2,3,4,5,7,9,10,11,13,14,15,16,17,20,18,19,23];
    include '../LoadVar.php';
?>
<html dir="ltr" lang="pt-BR">
    <head>
        <meta name="description" content="Fila Estática Circular é uma adaptação da Fila Estática para reaproveitar as posições vazias, geradas após a remoção. Na maioria das vezes é chamada só de Fila Estática">
    ...
    <body id="bd">
        ...
        <script src="./js/Estruturas/fila_estatica_circular.js"></script>
