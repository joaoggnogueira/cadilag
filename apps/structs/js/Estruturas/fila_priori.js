...
(function () {
    ...
    animationAdd = function (elId, lastPosIns) {
        ...
        if (collection.ini.prox !== null) { //Caso a fila não estiver vazia
            ...
            while (i !== lastPosIns) {
                ...
                highlighter.line(8, looptime + 500);
                highlighter.line(9, looptime + 1000);
                i++;
                ant = elem;
                elem = elem.prox;
            }
            timeout(function() {
                ...
                if (elem.prox !== null) {
                    ...
                    if (ant === null) {
                        ...
                        highlighter.lineRed(26, 1200);
                        highlighter.line(29, 1500);
                    }
                    highlighter.line(30, 1750);
                }
            ...
            highlighter.clear(500);
            highlighter.lineRed(6, 500);
            highlighter.line(27, 1000);
            highlighter.lineRed(11, 1000);
            highlighter.line(29, 1300);
    ...
    animationRemove = function () {
        ...
        if (collection.ini !== null) {
            ...
            Plumb.showMessage("Fila vazia",2000);
    ...
    createDisc = function (value, prior,withPointer) {
        var elem = Element.createElement(
                {className: "dinamicDot altColor",
                    innerHTML: "<span class='itemValuePriori altColorTitle'>" + value + "</span><span class='itemPriori altColorTitle'>" + prior + "</span>",
                    left: "100px",
                    top: "75px",
                    title: value + "/" + prior,
                    idParent: "main"});
    ...
    window.Cadilag = {
        ...
        addDisc: function () {
            if (UI.checkInterface()) {
                ...
                if ((value !== "") && (prior !== "")) {
                    var info = createDisc(value, prior,true);
