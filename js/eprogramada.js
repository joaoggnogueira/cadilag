    ...
    setEpDetails = function (id, rotulo) {
        if (id != -1) {
            ...
            nextEp = function () {
                ...
                var column = 0;
                objList.each(function () {
                    $(this).val(getInputObj(i, column).val());
                    column++;
                });
            ...
            loadEp = function () {
                var callbackFunction = function (data) {
                    ...
                    eps += "</select>";
                    eps += "</div>";
                    swal({title: "Selecione uma entrada", text: eps, html: true, confirmButtonColor: "#DD6B55", confirmButtonText: "Carregar", cancelButtonText:"Cancelar", closeOnConfirm: true, showCancelButton: true}, function () {
