...
//        }
        ...
        if (collection.cabeca.prox !== null) {
            ...
            while(leitor !== null) {
                ...
                if(info.valor*1===leitor.valor*1) {
                    if(leitor.ant!==null) {
                        Plumb.moveTo(info.id,posFim.left+125,posFim.top-60,1000);
                        Plumb.moveTo(info.id,posFim.left+125,posFim.top,1000);
                    } else {
                    ...
                    timeout( function() {
                        ...
                        highlighter.lineRed(4,500);
                        if(leitor.prox !== null) {
                            highlighter.line(9,1000);
                            if(leitor.ant === null){
                                highlighter.line(11,1500);
                                highlighter.lines(13,15,2000);
                                highlighter.clear(2000);
                            } else {
                                highlighter.line(17,1500);
                                highlighter.lineRed(11,1500);
                                highlighter.lines(19,22,2000);
                                highlighter.clear(3000);
                            }
                        } else {
                            highlighter.line(25,900);
                            highlighter.lineRed(9,900);
                            if(leitor.ant === null){
                                highlighter.line(27,1500);
                                highlighter.line(28,2000);
                                highlighter.clear(3000);
                            } else {
                                highlighter.line(29,1500);
                                highlighter.lineRed(27,1500);
                                highlighter.lines(31,32,2000);
                                highlighter.clear(3000);
                            }
                ...
                highlighter.line(6,looptime+600);
                highlighter.line(7,looptime+1200);
                leitor = leitor.prox;
                i++;
            }
        } else {
            highlighter.clear(450);
            highlighter.lineRed(4,450);
            highlighter.line(25,900);
            highlighter.lineRed(9,900);
            highlighter.line(27,1350);
            highlighter.line(28,1600);
            highlighter.clear(2000);
            Plumb.moveTo(info.id,posFim.left,posFim.top,2000);
            timeout( function() {
                setInitial(info.id,true);
    ...
    prepareAnt = function (elId) {
        return Plumb.adicionarPontoDeConexao(elId,{anchor:[1, 0.3, 0, -1],isSource:false,isTarget:true,isPrimary:true});
    },
    prepareProx = function (elId) {
        return Plumb.adicionarPontoDeConexao(elId,{anchor:[0, 0.3, 0, -1],isSource:true,isTarget:false,isPrimary:true});
    },
    prepareAnt2 = function (elId) {
        return Plumb.adicionarPontoDeConexao(elId,{anchor:[0, 0.7, 0, -1],isSource:false,isTarget:true,isPrimary:false});
    },
    prepareProx2 = function (elId) {
        return Plumb.adicionarPontoDeConexao(elId,{anchor:[1, 0.7, 0, -1],isSource:true,isTarget:false,isPrimary:false});
    },
