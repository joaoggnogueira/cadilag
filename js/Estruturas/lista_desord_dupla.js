...
(function () {
            ...
            if (temp!==null) {
                ...
                Plumb.blink(temp.dados.id,4000,function(){
                    Plumb.fadeOut(temp.dados.id,1000,function(){
                        ...
                        disconnectDisc(temp);
                        deslocarApartir(temp.prox,-125,2000);
    ...
    prepare = function (elId) {
        return Plumb.adicionarPontoDeConexao(elId,{isSource:true,isTarget:false,isPrimary:false,anchor: [1, 0.7, 0, -1]});
    },
    prepare2 = function (elId) {
        return Plumb.adicionarPontoDeConexao(elId,{isSource:true,isTarget:false,isPrimary:true,anchor: [0, 0.3, 0, -1]});
    },
    prepare3 = function (elId) {
        return Plumb.adicionarPontoDeConexao(elId,{isSource:false,isTarget:true,isPrimary:true,anchor: [1, 0.3, 0, -1]});
    },
    prepare4 = function (elId) {
        return Plumb.adicionarPontoDeConexao(elId,{isSource:false,isTarget:true,isPrimary:false,anchor: [0, 0.7, 0, -1]});
    },
