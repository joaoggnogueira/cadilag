...
(function () {
    ...
    showArrowOnNext = function(origemindex){
        ...
        if(destinoindex !== "-1"){
            var endpointorigem = jsPlumb.addEndpoint("arraynext"+origemindex, {
                anchor: "Top",
                paintStyle: {fillStyle: "#000000",radius: 5},
                connectorStyle: {lineWidth: 3, strokeStyle: "#000000"},
    ...
    draw = function () {
        ...
        for(var i=0;i<collection.MAX;i++){
            ...
            const index = i;
            $("#arraynext"+i).mouseover(function(){
    ...
    window.Cadilag = {
        ...
        elementIndexToString: function (index) {
            ...
            if (arraypos.value === null || arraypos.value === undefined) {
                return {'info':'nulo','proximo_elemento':arraypos.proximoElemento,'_index':index,'_title':'Lista'};
            } else {
                return {'info':arraypos.value,'proximo_elemento':arraypos.proximoElemento,'_index':index,'_title':'lista'};
            }
            return false;
        },
        elementToString:function(id){
            ...
            if(element !== undefined){
                ...
                var result = {'info':element.value,'proximo_elemento':element.proximoElemento,'_index':vars.index,'_title':'lista','_gravity':(vars.index===0?'sw':(vars.index===collection.MAX-1?'se':'s'))};
                return result;
            }
            return false; 
        },
