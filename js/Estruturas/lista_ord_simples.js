...
(function () {
    ...
    animationAdd = function (info) {
        ...
        if (collection.cabeca.prox !== null) { //caso não vazio
                    ...
                    timeout(function(){
                        ...
                        timeout( function() {
                            ...
                            if (leitor.prox === null) {
                                ...
                                if(ant === null) {
                                    highlighter.line(24,2000);
                                    highlighter.line(25,2500);
                                } else {
                                    highlighter.lineRed(24,2000);
                                    highlighter.line(26,2000);
                                    highlighter.line(27,2500);
                                ...
                                if(ant === null) {
                                    ...
                                    highlighter.line(16,2000);
                                    highlighter.lineRed(11,2000);
                                    highlighter.line(18,2500);
                                    highlighter.line(19,3000);
                                }
            ...
            highlighter.lineRed(4,1500);
            highlighter.clear(2000);
            highlighter.line(22,2000);
            highlighter.lineRed(9,2000);
            highlighter.line(24,2500);
            highlighter.line(25,3000);
