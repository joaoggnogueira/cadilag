...
(function () {
    ...
    animationAddList = function (info, ind) {
        ...
        var disc;
        var pos = {left: 550, top: 75 + (ind * 52)};
        ...
        if(cabeca == null) {
            ...
            highlighter.lineRed(5,3000);
            highlighter.line(7,3000);
            highlighter.line(9,3500);
            highlighter.line(10,4000);
            disc = createDiscLinha(614,69 + (ind * 52));
            $("#"+disc.id).hide();
            timeout(function(){
                $("#"+disc.id).show();
            ...
            var moveTo = function(left) {
                timeout(function(){
                    Plumb.moveTo(disc.id,left + 68,69 + (ind * 52),2000);
                },4000);
            };
            while (cabeca != null) {
                i++;
                pos = {left: parseInt(cabeca.ref.style.left), top:  75 + (ind * 52)};

                if (cabeca.value*1 > info.valor*1) {
                    break;
                }
                highlighter.line(11,i*2000+2500);
                highlighter.line(13,i*2000+3000);
                highlighter.line(14,i*2000+3500);
            ...
            highlighter.lineRed(11,i*2000+4000);
            if(cabeca === null) {
                highlighter.lineRed(16,i*2000+4500);
                highlighter.line(29,i*2000+5000);
                highlighter.line(30,i*2000+5500);
            } else {
                highlighter.line(16,i*2000+4500);
                if(anterior!==null) {
                    highlighter.line(18,i*2000+5000);
                    highlighter.lines(20,21,i*2000+6000);
                } else {
                    highlighter.lineRed(18,i*2000+5000);
                    highlighter.line(23,i*2000+5000);
                    highlighter.lines(25,26,i*2000+6000);
    ...
    animationSearchList = function (info, ind) {
        ...
        Plumb.moveTo(info.id,pos.left, pos.top, 2000);
        var disc = createDiscLinha(614,69 + (ind * 52));
        $("#"+disc.id).hide();
        timeout(function(){
            $("#"+disc.id).show();
            StepRecord.add("Leitor aponta para o ínicio da fila");
        ...
        var moveTo = function(left) {
            timeout(function(){
                Plumb.moveTo(disc.id,left + 69,69 + (ind * 52),2000);
            },4000);
        };
        while (cabeca != null) {
            i++;
...
//            Plumb.moveTo(info.id,pos.left + 80,pos.top,2000);
        ...
        timeout(function() {
            ...
            if (cabeca != null && cabeca.value == info.valor) {
                ...
                Plumb.blink(cabeca.id,4000,function(){
                    ...
                    deslocarApartir(cabeca.prox,-75,2000);
                });
            } else {
                StepRecord.add("Elemento não foi encontrado");
    ...
    populateDotArray = function () {
        ...
        for (var i = 0; i < collection.MAX; ++i) {
            pointerDots[i] = createPointerDot((i * 52 + 75) + "px", 622 + "px", "10px 0px 0px 10px");
        }
    },
